...
| **DevOps** | Using DevOps tools to build practical understanding of how each tool works, implementing complete workflows from scratch | Docker, Kubernetes, Jenkins, Terraform, Ansible, Prometheus, Grafana | - CI/CD Pipeline Setup <br> - Docker Containerization <br> - Kubernetes Deployment <br> - Terraform (IaC) <br> - Monitoring Setup                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
